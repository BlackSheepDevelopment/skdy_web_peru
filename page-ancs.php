...
<div class="main_anc">
    ...
    <div class="content_anc">	
        ...
        <div class="info_anc">
            <h2 class="subtitle_anc">Experimenta la Calma Absoluta: Descubre los Beneficios del ANC.</h2>
            <ul class="list_anc">
                <li class="list_item_anc">
                    ...
                    <p>
                    Aísla el ruido y sumérgete en tu música favorita.
                    </p>    
                </li>
                ...
                <li class="list_item_anc">
                    ...
                    <p>Elimina distracciones y enfócate en tu trabajo o estudio.</p>
                </li>
                ...
                <li class="list_item_anc">
                    ...
                    <p>Disfruta de tus canciones a volúmenes más bajos.</p>
                </li>
                ...
                <li class="list_item_anc">
                    ...
                    <p>Reduce el ruido del aviones y coches para relajarte.</p>
                </li>
            </ul>
        </div>
    </div>
                ...
                <div class="product_anc_features">
                    ...
                    <ul class="product-features-list">
                        <li class="product-features-item">
                            <svg class="product-features-item__icon" width="38px" height="38px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M18 9.00009C18.6277 9.83575 18.9996 10.8745 18.9996 12.0001C18.9996 13.1257 18.6277 14.1644 18 15.0001M6.6 9.00009H7.5012C8.05213 9.00009 8.32759 9.00009 8.58285 8.93141C8.80903 8.87056 9.02275 8.77046 9.21429 8.63566C9.43047 8.48353 9.60681 8.27191 9.95951 7.84868L12.5854 4.69758C13.0211 4.17476 13.2389 3.91335 13.4292 3.88614C13.594 3.86258 13.7597 3.92258 13.8712 4.04617C14 4.18889 14 4.52917 14 5.20973V18.7904C14 19.471 14 19.8113 13.8712 19.954C13.7597 20.0776 13.594 20.1376 13.4292 20.114C13.239 20.0868 13.0211 19.8254 12.5854 19.3026L9.95951 16.1515C9.60681 15.7283 9.43047 15.5166 9.21429 15.3645C9.02275 15.2297 8.80903 15.1296 8.58285 15.0688C8.32759 15.0001 8.05213 15.0001 7.5012 15.0001H6.6C6.03995 15.0001 5.75992 15.0001 5.54601 14.8911C5.35785 14.7952 5.20487 14.6422 5.10899 14.4541C5 14.2402 5 13.9601 5 13.4001V10.6001C5 10.04 5 9.76001 5.10899 9.54609C5.20487 9.35793 5.35785 9.20495 5.54601 9.10908C5.75992 9.00009 6.03995 9.00009 6.6 9.00009Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>    
                ...
                <div class="product_anc_features">
                    ...
                    <ul class="product-features-list">
                        <li class="product-features-item">
                            ...
                            <p>Hasta 19 horas de batería total (con ANC prendido)
                            </p>
                        </li>
                        <li class="product-features-item">
                            <svg class="product-features-item__icon" width="38px" height="38px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="product-features-item">
                            ...
                            <p>
                                Sonido personalizado a través de la aplicación
                            </p>
                        </li>
                    ...
                    <a id="product_anc_CTA" class="product_anc_CTA" href="https://skullcandy.com.pe/producto/indy-anc-noise-canceling-true-wireless/">¡COMPRALOS AQUÍ!</a>
                </div>
                ...
                <div class="product_anc_features">
                    ...
                    <ul class="product-features-list">
                        <li class="product-features-item">
                            ...
                            <p>Hasta 6 horas de batería total (con ANC prendido)
                            </p> 
                        </li>
                        <li class="product-features-item">
                            <svg class="product-features-item__icon" width="38px" height="38px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="product-features-item">
                            ...
                            <p>
                                IPX4 Resistente al sudo y agua
                            </p>
                        </li>
                    ...
                    <a id="product_anc_CTA" class="product_anc_CTA" href="https://skullcandy.com.pe/producto/method-active-wireless-sport-earbuds/">¡COMPRALOS AQUÍ!</a>
                </div>
