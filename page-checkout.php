        ...
        <div class="content">
			...
			<div class="shop-features">
				...
				<div class="shop-features__container">
					...
					<div class="shop-features__container__info">
						<p class="shop-features__container__info__title">Cómpralo antes de las 4:00 PM y te lo entregamos al día siguiente (Lima Metropolitana y Callao, solo Lunes a Jueves) </p>
					</div>
