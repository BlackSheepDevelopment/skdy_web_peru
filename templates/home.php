    ...
    <div class="main-container">
        <div id="home-grid">
            <div class="home-picture" id="skullcandy-peru-container">
                <picture>
                    <video class="home-grid__picture" src="<?php echo get_template_directory_uri() ?>/src/assets/PORTADA_WEB_SKDY.mp4" autoplay muted loop></video>
                </picture>
            </div>
        ...
        <div class="shop-features">
            ...
            <div class="shope-features__main" >
