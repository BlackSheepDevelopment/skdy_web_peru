...
?>
    ...
    $user_id = $user->ID;
    $partner_company = get_user_meta($user_id, 'partner_company', true);
    $partner_ruc = get_user_meta($user_id, 'partner_ruc', true);
    $partner_recieve_name = get_user_meta($user_id, 'partner_recieve_name', true);
    $partner_recieve_lastname = get_user_meta($user_id, 'partner_recieve_lastname', true);
    $partner_recieve_id = get_user_meta($user_id, 'partner_recieve_id', true);
